            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Laporan Surat Keluar</h6>
                </div>
                <div class="container">
                  <form method="POST">
                    <div class="row">
                          ...
                          <div class="custom-form">
                              <div class="form-group">
                                  ...
                                  <select class="form-control" id="status" name="status">
                                    ...
                                    <option value="2">Dicek Pimpinan</option>
                                    <option value="3">Siap Kirim</option>
                                    <option value="0">Cek Ulang</option>
                ...
                <div class="table-responsive p-3">
                  <a class="btn btn-sm btn-success" href="cetak_semua_sk.php?tanggal=<?php echo $tanggal; ?>&status=<?php echo $status; ?>" target="_blank">Cetak Semua</a><br><br>
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM tb_sk WHERE tgl_sk = '$tanggal' AND status = '$status'";
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-sm btn-success" href="cetak_sk.php?id=<?php echo $row['id_sk']; ?>&tanggal=<?php echo $tanggal; ?>&status=<?php echo $status; ?>" target="_blank"><i class="fas fa-print"></i> Cetak</a>
                        </td>
                      </tr>
                      <?php } ?>
                    </tbody>
